...
`ifdef WARP
`define CY_BLK_DIR "S:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "S:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`else
`define CY_BLK_DIR "S:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "S:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`endif
...
module SPI_Master_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("80715caa-1751-41c3-badd-6145d0e18203/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
    ...
    SPI_Master_v2_50_1 SPI_M (
        ...
        .ss(Net_27),
        .tx_interrupt(Net_22));
    defparam SPI_M.BidirectMode = 0;
    defparam SPI_M.HighSpeedMode = 0;
    defparam SPI_M.NumberOfDataBits = 8;
    defparam SPI_M.ShiftDir = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("fea6d3a0-01b2-442d-bc9e-a3c40804e7a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
